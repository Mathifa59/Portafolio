...
export const t = {
  es: {
    ...
    projects: {
      ...
      featuredLabel: "Último cliente",
      realClientsTitle: "Más Clientes Reales",
      realClientsSub: "Productos con resultados medibles para negocios reales en producción.",
      demosTitle: "Demos & Showcase",
      demosSub: "Proyectos de práctica que demuestran capacidades técnicas. No son clientes reales.",
  ...
  en: {
    ...
    projects: {
      ...
      featuredLabel: "Latest client",
      realClientsTitle: "More Real Clients",
      realClientsSub: "Products with measurable results for real businesses in production.",
      demosTitle: "Demos & Showcase",
      demosSub: "Practice projects that demonstrate technical capabilities. Not real clients.",
